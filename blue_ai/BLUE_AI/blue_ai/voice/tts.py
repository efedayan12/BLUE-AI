...
class TTSEngine:
    ...
    async def _speak_edge(self, text: str) -> bool:
        ...
        try:
            ...
            # Windows Media.SoundPlayer ile calmak (tek instance, dogru kullanim)
            self._is_speaking = True
            ps_script = (
                f'Add-Type -AssemblyName PresentationCore; '
                f'$player = New-Object System.Windows.Media.MediaPlayer; '
                f'$player.Open([Uri]"{output_file}"); '
                f'$player.Play(); '
                f'Start-Sleep -Milliseconds 500; '
                f'while($player.Position -lt $player.NaturalDuration.TimeSpan -and '
                f'$player.NaturalDuration.HasTimeSpan) {{ Start-Sleep -Milliseconds 200 }}; '
            ...
            if self._current_process:
                ...
                self._current_process = None
            self._is_speaking = False
            return True  # Dosya uretildi, ses caldi ama uzun surdu
        except Exception as e:
